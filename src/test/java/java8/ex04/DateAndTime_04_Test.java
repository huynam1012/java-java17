...
public class DateAndTime_04_Test {
    ...
    public void test_localDateTime_of() {
        ...
        LocalDateTime result1 = LocalDateTime.of(2018, 01, 01, 12, 00, 00);

        // TODO valoriser les différentes variables afin de rendre le test passant
        int hour = result1.getHour();
        int minutes = result1.getMinute();
        int second = result1.getSecond();
    ...
    public void test_localDateTime_parse() {
        ...
        LocalDateTime result2 = LocalDateTime.parse("2009-03-02T09:30:00", DateTimeFormatter.ISO_LOCAL_DATE_TIME);

        // TODO valoriser les différentes variables afin de rendre le test passant
        int hour = result2.getHour();
        int minutes = result2.getMinute();
        int second = result2.getSecond();
